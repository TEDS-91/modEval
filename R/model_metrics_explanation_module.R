...
model_explanationUI <- function(id) {
  ...
  shiny::tagList(
    ...
    shiny::tags$b("Bias (%), Dev. of the Regression (%), and Random variation (%):"),        "decomposition of the MSE according to",
    shiny::tags$a(href = "https://onlinelibrary.wiley.com/doi/abs/10.1002/bimj.197800029", "Bibby and Toutenburg (1977)"),
    shiny::tags$em("[Prediction and improved estimation in linear models]."),
